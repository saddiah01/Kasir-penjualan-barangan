...
<div class="row">
	<div class="col-sm-3">
		<div class="card card-primary">
			...
			<div class="card-body">
				<img src="./assets/images/logo_toko.png<?php echo $hasil['logo_toko.png'];?>" alt="#" class="logo_toko.png w-100" />
			</div>
			<div class="card-footer">
				<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
					<input type="file" accept="image/*" name="foto">
					<input type="hidden" value="<?php echo $hasil['logo_toko.png'];?>" name="foto2">
